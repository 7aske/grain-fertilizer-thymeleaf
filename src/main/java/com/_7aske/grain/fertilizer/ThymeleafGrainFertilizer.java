 ...
 * exception is the {@link com._7aske.grain.web.ui.impl.DefaultLoginPage} which is not
 ...
 */
@GrainFertilizer
public class ThymeleafGrainFertilizer {
    ...
    ViewResolver thymeleafViewResolver(
        ...
        return new ViewResolver() {
            ...
            public boolean supports(View view) {
                return view.getName().toLowerCase().endsWith(".html");
            }
